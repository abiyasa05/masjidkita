                                                                        ...
                                                                        <div class="owl-carousel" data-plugin-options='{"items":1, "dots": true, "nav": false, "autoplay": true, "loop": true, "responsive": {}}'>
                                                                            <div class="property-item">
                                                                                <div class="property-inner">
                                                                                    <div class="property-image"> <img width="370" height="180" src="<?= base_url('assets/'); ?>wp-content/uploads/2000/istiqlal.jpg" onerror="this.src = '../../wp-content/uploads/2017/12/no-image-370x180.jpg';" alt="Masjid Istiqlal" title="Masjid Istiqlal">
                                                                            ...
                                                                            <div class="property-item">
                                                                                <div class="property-inner">
                                                                                    <div class="property-image"> <img width="370" height="180" src="<?= base_url('assets/'); ?>wp-content/uploads/2000/jami.jpg" onerror="this.src = '../../wp-content/uploads/2017/12/no-image-370x180.jpg';" alt="Masjid Jami'" title="Masjid Jami'">
                                                                                        <div class="property-action block-center">
                                                                                            <!-- <div class="block-center-inner">
                                                                            ...
                                                                            <div class="property-item">
                                                                                <div class="property-inner">
                                                                                    <div class="property-image"> <img width="370" height="180" src="<?= base_url('assets/'); ?>wp-content/uploads/2000/turen.jpg" onerror="this.src = '../../wp-content/uploads/2017/12/no-image-370x180.jpg';" alt="Masjid Tiban Turen" title="Masjid Tiban Turen">
                                                                                        <div class="property-action block-center">
                                                                                            <!-- <div class="block-center-inner">
                                                                ...
                                                                <div class="col-sm-6 ere-profile-avatar">
                                                                    <div id="user-profile-img">
                                                                        <div class="profile-thumb">
                                                                            <img width="150" height="150" id="profile-image" src="" onerror="this.src = '<?= base_url('assets/'); ?>wp-content/plugins/essential-real-estate/public/assets/images/download.png';" alt="User Avatar">
