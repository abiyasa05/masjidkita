        ...
        <div class="col-lg-3" style="margin-top: 2%">
            ...
            <div class="panel widget" style="height:250px">
                <div class="widget-header bg-default">
                    <img class="widget-bg img-responsive" src="<?php echo base_url() ?>assets/img/<?php echo $res->foto_siswa ?>" alt="Image">
                </div>
                <div class="text-center" style="margin-top:15px;">
                    ...
                    <p class="text-muted mar-no" style="height:20px;">
                        <?= substr($res->kelas_siswa, 0, 35) ?>
                    </p>
                </div>
                <div class="pad-all text-center">
                    <span>
                        <a data-toggle="modal" data-target="#demo-default-modal1<?php echo $res->id_siswa ?>" class=" btn btn-success btn-sm">
                            <span class="fa fa-edit"></span>
                            &nbsp;Edit
                        </a>
                    </span>
                    <span>
                        <a data-toggle="modal" data-target="#demo-default-modal2<?php echo $res->id_siswa ?>" class=" btn btn-danger btn-sm">
                            <span class="fa fa-trash"></span>
                            &nbsp;Hapus
                        </a>
                        <a data-toggle="modal" data-target="#demo-default-detail<?php echo $res->id_siswa ?>" class=" btn btn-default btn-sm">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="nama_siswa" placeholder="Nama Sekolah" class="form-control" value="<?= $res->nama_siswa ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="" class="control-label">Logo</label>
                                    <input type="file" name="foto_siswa" placeholder="Logo Sekolah" class="form-control" id="userfile" onchange="tampilkanPreview(this,'preview')">
                                </div>
                                <div class="col-md-6" style="margin-top: 2%">
                                    <label for="" class="control-label">Keterangan</label>
                                    <textarea type="text" name="kelas_siswa" rows="5" placeholder="Keterangan" class="form-control"><?= $res->kelas_siswa ?></textarea>
                                </div>
                                <div class="col-md-6 " style="margin-top: 2%">
            ...
            <!-- detail -->
            <div class="modal fade" id="demo-default-detail<?php echo $res->id_siswa ?>" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn btn-danger" href="<?php echo base_url('data_siswa/hapus/' . $res->id_siswa) ?>">Hapus Sekolah</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-6">
                            <label for="" class="control-label">Nama Sekolah</label>
                            <input type="text" name="nama_siswa" placeholder="Nama Sekolah" class="form-control">
                        </div>
                        <div class="col-md-6">
                            <label for="" class="control-label">Logo</label>
                            <input type="file" name="foto_siswa" placeholder="Logo Sekolah" class="form-control" id="userfile" onchange="tampilkanPreview(this,'preview')">
                        ...
                        <div class="col-md-6" style="margin-top: 2%">
                            <label for="" class="control-label">Keterangan</label>
                            <textarea type="text" name="kelas_siswa" rows="5" placeholder="Keterangan" class="form-control"></textarea>
                        </div>
                        <div class="col-md-6 " style="margin-top: 2%">
                            <label for="" class="control-label">Preview Foto Profile</label>
